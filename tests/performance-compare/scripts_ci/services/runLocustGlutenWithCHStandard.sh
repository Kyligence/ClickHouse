...
cp /tmp/gluten_commit_ids ${result_dir}/
cp /tmp/chbackend_commit_ids ${result_dir}/
cp /tmp/gluten_commit_ids ${result_dir}_inner/
cp /tmp/chbackend_commit_ids ${result_dir}_inner/
